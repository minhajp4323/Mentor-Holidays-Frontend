...
export const fullProperties = [
  ...
  {
    title: "Cottage amidst the mountains",
    category: "farm",
    location: "Munnar, Kerala",
    pool: true,
    guest: 4,
    ...
    bathroom: 3,
    description:
      'Cosy independent cottages surrounded by lush green mountains with a view of the "annaerangal" lake . Total area of the propety is around 3.00 acres so lots of space for my guests to relax and enjoy',
    // images: farm2,
    price: 3999,
  },
  {
  ...
  {
    title: "Backwater-Facing Cottages In Kadamakkudy",
    category: "lake",
  ...
  {
    title: "Parudeesa (Moksha)five Secure Lux Suites in Kerala",
    category: "lake",
  ...
  {
    title: "Stone House, Silver Oaks Nature Retreat",
    category: "pool",
    location: "Idukki, Kerala",
    pool: true,
    guest: 3,
  ...
  },
  {
    ...
    bathroom: 1,
    description:
      "Welcome to your serene escape on Sarjapur Road, Bangalore. Nestled beside a picturesque organic pond, our newly designed Airbnb offers modern comforts and natural beauty. With a loft bedroom, stylish decor, it's the perfect retreat for your stay.  Did we mention our stay is pet friendly as well ?",
    price: 7000,
  },
  {
    title: "Traditional Kerala Heaven",
    category: "room",
